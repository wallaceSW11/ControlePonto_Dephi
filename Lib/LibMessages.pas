...
uses
  vcl.Dialogs, SysUtils, winapi.windows, vcl.forms, libtypes, stdCtrls, uTEditHelper;
...
begin
  MessageBox(application.handle, PWideChar(pMensagem), PWideChar('Informação') , MB_ICONINFORMATION + MB_OK);
